function solution() {
    ...
    class Employee {
        constructor(name, age) {
            //a way to make the class abstract(non-instantiable)
            //new.target -> checks if the target of the 'new' special word is the class Employee
            //for example if new targets Employee -> new Employee() -> it will throw error
